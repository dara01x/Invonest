...
export const translations = {
  en: {
    ...
    analyticsAndTrackingDesc: "We use Google Analytics to understand general usage patterns and improve our service. Google Analytics may set cookies and collect information such as your approximate location, device type, and browsing behavior on this site. This data is used in aggregate and is never linked to any invoice data you create, which always stays local to your device.",
    thirdPartyServices: "Third-Party Services",
    thirdPartyServicesDesc: "Invonest uses third-party services including Google Analytics (usage analytics), Google AdSense (to display advertising), and Mailchimp (for our newsletter, if you subscribe). These providers may set their own cookies and process data according to their own privacy policies. None of these services have access to your invoice data, as all invoice processing happens locally in your browser.",
    ...
    cookies: "Cookies & Advertising",
    cookiesDesc: "We use essential cookies and local storage to maintain your language preferences and basic application functionality. We also allow Google and other advertising partners to use cookies to serve ads based on your visits to this and other websites. You can opt out of personalized advertising via Google's Ads Settings (adssettings.google.com) or www.aboutads.info/choices.",
  ...
  ar: {
    ...
    analyticsAndTrackingDesc: "نستخدم Google Analytics لفهم أنماط الاستخدام العامة وتحسين خدمتنا. قد تضع أداة Google Analytics ملفات تعريف ارتباط وتجمع معلومات مثل موقعك التقريبي ونوع جهازك وسلوك التصفح على هذا الموقع. تُستخدم هذه البيانات بشكل مجمّع ولا ترتبط أبداً بأي بيانات فواتير تُنشئها، والتي تبقى دائماً محلية على جهازك.",
    thirdPartyServices: "خدمات الطرف الثالث",
    thirdPartyServicesDesc: "يستخدم إنفونست خدمات طرف ثالث تشمل Google Analytics (لتحليل الاستخدام)، وGoogle AdSense (لعرض الإعلانات)، وMailchimp (للنشرة البريدية، في حال اشتراكك). قد تضع هذه الجهات ملفات تعريف ارتباط خاصة بها وتعالج البيانات وفقاً لسياسات الخصوصية الخاصة بها. لا تملك أي من هذه الخدمات وصولاً إلى بيانات فواتيرك، حيث تحدث جميع المعالجات محلياً في متصفحك.",
    ...
    cookies: "ملفات تعريف الارتباط والإعلانات",
    cookiesDesc: "نستخدم ملفات تعريف الارتباط الأساسية والتخزين المحلي للحفاظ على تفضيلات اللغة ووظائف التطبيق الأساسية. كما نسمح لجوجل وشركاء إعلانيين آخرين باستخدام ملفات تعريف الارتباط لعرض إعلانات بناءً على زياراتك لهذا الموقع ومواقع أخرى. يمكنك إلغاء الاشتراك في الإعلانات المخصصة من خلال إعدادات إعلانات جوجل (adssettings.google.com) أو www.aboutads.info/choices.",
  ...
  ckb: {
    ...
    analyticsAndTrackingDesc: "ئێمە Google Analytics بکارئینین ژبو تێگەهشتنا شێوازێن بەکارهێنانا گشتی و باشترکرنا خزمەتگوزاریا خو. Google Analytics دشێت کووکیزان دابنیت و زانیاریان وەکو شوینا تە یا نێزیکی، جورێ ئامێرێ تە و رێوشوێنێن گەڕانا تە ل سەر ڤێ مالپەڕێ کۆبکەت. ئەڤ داتایە ب شێوەیەکێ کۆمەڵایەتی تێدە بکارئینان و هەرگیز ب داتایێن پسوڵا تە ڤە نایێتە گرێدان، ئەوێن هەمیشە ب ناڤخۆیی د سەر ئامێرا تە دا دمینن.",
    thirdPartyServices: "خزمەتگوزاریێن ئلایێن سێیەم",
    thirdPartyServicesDesc: "ئینڤونێست خزمەتگوزاریێن ئلایێن سێیەم بکارئینیت، وەکو Google Analytics (ژبو شرۆڤەیێن بەکارهێنانێ)، Google AdSense (ژبو پیشاندانا رێکلاماں)، و Mailchimp (ژبو خەبەرنامەیا مە، ئەگەر تو بەشدار بی). ئەڤ خزمەتگوزاریان دشێن کووکیزێن خو یێن تایبەت دابنن و داتایان بگوهرە سیاسەتێن نهێنیا خو یێن تایبەت پروسێس بکەن. هیچیەک ژ ڤان خزمەتگوزاریان گەهشتنەکا ب داتایێن پسوڵا تە نینە چونکو هەمی پروسێسکرن ب ناڤخۆیی د ناڤا مروگەرا تە دا ددەن ئەنجام.",
    ...
    cookies: "کووکیز و رێکلام",
    cookiesDesc: "ئێمە کووکیزێن بنەڕەتی و ڤەگرتنا ناڤخۆیی ژبو پاراستنا ترجیحێن زمانی و کارکردنێن بنەڕەتیێن ئەپلیکەیشنێ بکارئینین. هەروەسا ئێمە ڕێ ددەین Google و هاوبەشێن رێکلامان یێن دن کووکیزان بکارئینن ژبو پیشاندانا رێکلاماں لسەر بنەمایێ سەردانێن تە یێن ڤێ مالپەڕێ و مالپەڕێن دن. تو دشێی رێکلامێن تایبەتکری ڕەت بکەی ب ڕێکا ڕێکخستنێن رێکلامێن Google (adssettings.google.com) یان www.aboutads.info/choices.",
