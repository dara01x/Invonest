...
export const translations = {
  ...
  ckb: {
    ...
    invoiceTitleExample1: "وەصلا پروفێشنال",
    invoiceTitleExample2: "وەصلا بازرگانی",
    invoiceTitleExample3: "وەصلا خزمەتگوزاری",
    invoiceTitleExample4: "وەصلا باج",
    invoiceTitleHelp: "کلیک بکە دا کو ناڤێ وەصلێ بدانی",
    ...
    customerPhonePlaceholder: "+1 (555) 987-6543",
    invoiceNumberPlaceholder: "ژمارا وەصلێ",
    ...
    // Dashboard and UI
    generateProfessionalInvoices: "درستکرنا وەصلێ بشێوەیەکێ مودرێن و ئاسان ",
    colorTheme: "ڕەنگی وەصلێ",
    uploadCompanyLogo: "لوگویێ خو ئەپلود بکە",
    invoiceNumber: "ژمارا وەصلێ",
    date: "رێکەفت",
    previewInvoice: "دیتنا وەصلێ",
    downloadInvoice: "داونلودکرنا وەصلێ",
    itemName: "ناڤێ کاری",
    additionalDetails: "پێزانینێن زێدەتر لسەر کاری",
    discountQuestion: "رێژا داشکاندنێ ژێبگرە",
    
    // Landing Page
    landingTitle: "درووستکرنا وەصلێن پرۆفیشناڵ بێ بەرامبەر.",
    landingTitlePart1: "درووستکرنا وەصلێن",
    landingTitlePart2: "پرۆفیشناڵ بێ بەرامبەر",
    landingSubtitle: "وەصلێن جوان و پروفێسنال دروست بکە. پشتەڤانی بۆ ئینگلیزی، عەرەبی و کوردی ب فۆرماتکرنا تەمام یا ژ راستێ بۆ چەپێ. پێدڤی ب تۆمارکرنێ نینە، ب تەمامی بێ بەرامبەرە.",
    freeForever: "١٠٠٪ بێ بەرامبەر بۆ هەتاهەتایە",
    makeInvoice: "وەصلا خو دروستبکە",
    ...
    // Features
    featuresTitle: "هەمی تشتێن پێدڤی ژبو دروستکرنا وەصلەکا پروفێشنال",
    featuresSubtitle: "هەمی تایبەتمەندیێن کو تو پێدڤی، ب تەمامی ب خۆڕایی و بێ سنۆر.",
    multiLanguage: "پشتەڤانیا چەند زمانان",
    multiLanguageDesc: "وەصلان دروست بکە ب زمانێن ئینگلیزی، عەرەبی و کوردی ب فۆرماتەکا تەمام یا راست-بۆ-چەپ و چەپ-بۆ-راست.",
    superFast: "زۆر بلەز",
    superFastDesc: "وەصلێن پیشەیی دروست بکە د کێمتر ژ دوو خولەکاندا ب رووکارێ مە یێ سادە و بکارئینانێ ئاسان.",
    ...
    instantPdf: "داونلودکرنا وەصلێ ب شێوازێ PDF",
    instantPdfDesc: "دشێی وەصلا خو بشێوازی pdf داونلود بکەی",
    beautifulThemes: "قالبێن جوان",
    ...
    professionalDesignDesc: "وەصلێن تازە و ئامادە بۆ کار کو کۆمپانیا تە پیشەیی ددەنە دیارکرن.",
    
    // How it Works
    howItWorksTitle: "چەوا کاردکەت",
    howItWorksSubtitle: "وەصلێن پیشەیی دروستبکە بتنێ د سێ پێنگاڤێن ئاسان دا",
    step1Title: "پرکردنا پێزانینێن وەصلێ",
    ...
    languageShowcaseSubtitle: "بجوانترین شێوە وەصلە دهێتە چێکرن ب هەرسێ زمانان",
    ...
    // Footer
    footerDescription: "دروستکەرێ وەصلێن پرۆفیشناڵ کو ١٠٠% بێ بەرامبەرە بۆ هەتاهەتایێ. فاکتوورێن جوان دروست بکە ب ئینگلیزی، عەرەبی و کوردی.",
    product: "بەرهەم",
    languages: "زمان",
