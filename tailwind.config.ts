    ...
    extend: {
      colors: {
        ...
        invoice: {
          ...
          'total-highlight': "hsl(var(--total-highlight))",
        },
        sidebar: {
      ...
      boxShadow: {
        ...
        '3xl': '0 25px 50px -12px rgba(0, 0, 0, 0.25), 0 25px 50px -12px rgba(59, 130, 246, 0.15)',
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      minHeight: {
        '44': '2.75rem', // 44px - minimum touch target size
